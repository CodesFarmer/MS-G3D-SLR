...
class Model(nn.Module):
    def __init__(self,
        ...
        self.sgcn1 = nn.Sequential(
            MS_GCN(num_gcn_scales, in_channels, c1, A_binary, disentangled_agg=True, dropout=0),
            MS_TCN(c1, c1),
            MS_TCN(c1, c1))
        ...
        self.sgcn2 = nn.Sequential(
            MS_GCN(num_gcn_scales, c1, c1, A_binary, disentangled_agg=True, dropout=0),
        ...
        self.sgcn3 = nn.Sequential(
            MS_GCN(num_gcn_scales, c2, c2, A_binary, disentangled_agg=True, dropout=0),
    ...
    def forward(self, x):
        ...
        feat = out.mean(1)   # Average pool number of bodies in the sequence
