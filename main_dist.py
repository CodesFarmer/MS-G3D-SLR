...
from graph.distributed import MMDistributedDataParallel
from graph.distributed import DistributedSampler
from graph.distributed import DistOptimizerHook
from graph.eval_hooks import DistEvalTopKAccuracyHook
from graph.center_loss import CenterLoss
...
class msg3d_with_loss(nn.Module):
    def __init__(self, backbone, loss, center_loss=False):
        super(msg3d_with_loss, self).__init__()
        self.network = backbone
        self.loss = loss
        if center_loss:
            self.center_loss = CenterLoss(226, 384)
        else:
            self.center_loss = None

    def forward(self, batchdata, label, return_loss=True):
        output, feat = self.network(batchdata)
        if not return_loss:
            return output
        label = label.view(-1)
        cla_losses = self.loss(output, label)
        if self.center_loss is not None:
            ctlosses = self.center_loss(feat, label)
            losses = cla_losses + ctlosses * 1.0
            return {"loss": losses, "cla_losses": cla_losses, "ctlosses": ctlosses}
        else:
            losses = cla_losses
            return {"loss": losses}
...
class Processor():
    ...
    def load_model(self):
        ...
        if self.arg.weights:
            ...
            if '.pth' in self.arg.weights:
                ...
                weights['data_bn.running_mean']=model_params['data_bn.running_mean']
                weights['data_bn.running_var']=model_params['data_bn.running_var']
                weights['fc.weight']=model_params['fc.weight']
                weights['fc.bias']=model_params['fc.bias']
                weights['gcn3d1.gcn3d.0.gcn3d.1.A_res']=model_params['gcn3d1.gcn3d.0.gcn3d.1.A_res']
                weights['gcn3d1.gcn3d.1.gcn3d.1.A_res']=model_params['gcn3d1.gcn3d.1.gcn3d.1.A_res']
                weights['sgcn1.0.A_res']=model_params['sgcn1.0.A_res']
                weights['gcn3d2.gcn3d.0.gcn3d.1.A_res']=model_params['gcn3d2.gcn3d.0.gcn3d.1.A_res']
                weights['gcn3d2.gcn3d.1.gcn3d.1.A_res']=model_params['gcn3d2.gcn3d.1.gcn3d.1.A_res']
                weights['sgcn2.0.A_res']=model_params['sgcn2.0.A_res']
                weights['gcn3d3.gcn3d.0.gcn3d.1.A_res']=model_params['gcn3d3.gcn3d.0.gcn3d.1.A_res']
                weights['gcn3d3.gcn3d.1.gcn3d.1.A_res']=model_params['gcn3d3.gcn3d.1.gcn3d.1.A_res']
                weights['sgcn3.0.A_res']=model_params['sgcn3.0.A_res']

                weights['gcn3d1.gcn3d.0.gcn3d.1.mlp.layers.0.weight']=model_params['gcn3d1.gcn3d.0.gcn3d.1.mlp.layers.0.weight']
                weights['gcn3d1.gcn3d.1.gcn3d.1.mlp.layers.0.weight']=model_params['gcn3d1.gcn3d.1.gcn3d.1.mlp.layers.0.weight']
                weights['sgcn1.0.mlp.layers.0.weight']=model_params['sgcn1.0.mlp.layers.0.weight']
                weights['gcn3d1.gcn3d.0.gcn3d.1.mlp.layers.0.bias'] = model_params['gcn3d1.gcn3d.0.gcn3d.1.mlp.layers.0.bias']
                weights['gcn3d1.gcn3d.0.gcn3d.1.mlp.layers.1.weight'] = model_params['gcn3d1.gcn3d.0.gcn3d.1.mlp.layers.1.weight']
                weights['gcn3d1.gcn3d.0.gcn3d.1.mlp.layers.1.bias'] = model_params['gcn3d1.gcn3d.0.gcn3d.1.mlp.layers.1.bias']
                weights['gcn3d1.gcn3d.0.gcn3d.1.mlp.layers.1.running_mean'] = model_params['gcn3d1.gcn3d.0.gcn3d.1.mlp.layers.1.running_mean']
                weights['gcn3d1.gcn3d.0.gcn3d.1.mlp.layers.1.running_var'] = model_params['gcn3d1.gcn3d.0.gcn3d.1.mlp.layers.1.running_var']
                weights['gcn3d1.gcn3d.0.out_conv.weight'] = model_params['gcn3d1.gcn3d.0.out_conv.weight']
                weights['gcn3d1.gcn3d.1.gcn3d.1.mlp.layers.0.bias'] = model_params['gcn3d1.gcn3d.1.gcn3d.1.mlp.layers.0.bias']
                weights['gcn3d1.gcn3d.1.gcn3d.1.mlp.layers.1.weight'] = model_params['gcn3d1.gcn3d.1.gcn3d.1.mlp.layers.1.weight']
                weights['gcn3d1.gcn3d.1.gcn3d.1.mlp.layers.1.bias'] = model_params['gcn3d1.gcn3d.1.gcn3d.1.mlp.layers.1.bias']
                weights['gcn3d1.gcn3d.1.gcn3d.1.mlp.layers.1.running_mean'] = model_params['gcn3d1.gcn3d.1.gcn3d.1.mlp.layers.1.running_mean']
                weights['gcn3d1.gcn3d.1.gcn3d.1.mlp.layers.1.running_var'] = model_params['gcn3d1.gcn3d.1.gcn3d.1.mlp.layers.1.running_var']
                weights['gcn3d1.gcn3d.1.out_conv.weight']=model_params['gcn3d1.gcn3d.1.out_conv.weight']
        ...
        self._model_full = msg3d_with_loss(self._model, self.loss, self.arg.center_loss)
        rank = int(os.environ['RANK'])
        # self._model.to(rank)
    ...
    def runner(self):
        ...
        Feeder = import_class(self.arg.feeder)
        self.runner.register_hook(DistEvalTopKAccuracyHook(Feeder(**self.arg.test_feeder_args), interval=self.arg.test_interval, k=(1, 5)))
