...
bone_pairs = {
    ...
    'hand': ((0, 1), (15, 0), (17, 15), (14, 0), (16, 14), (5, 1), (2, 1), # part neck 0-6
          ...
          (0, 58), (58, 59), (59, 60), (60, 61), # 73-76 
          (61, 62), (62, 63), (63, 64), (64, 65), # 77-80
          (65, 66), (66, 67), (67, 68), (68, 69), # 81-84
          (69, 70), (70, 71), (71, 72), (72, 73), # 85-98
          (73, 74), (74, 75), (75, 76), (76, 77) # 89-92
    )
}
    ...
    for benchmark in benchmarks[args.dataset]:
        for part in parts:
            ...
            try:
                ...
                fp_sp = open_memmap(
                    '../data/{}/{}_data_bone_b92.npy'.format(benchmark, part),
                    dtype='float32',
                    mode='w+',
                ...
                for bid, v_node in enumerate(bone_pairs[benchmark]):
                    v1, v2 = v_node
                    if benchmark != 'kinetics' and bid > 72:
                        v1 -= 1
                        v2 -= 1
                    # if bid < 7:
