...
bone_pairs = {
    ...
    'hand': ((0, 1), (15, 0), (17, 15), (14, 0), (16, 14), (5, 1), (2, 1), # part neck 0-6
          ...
          (25, 62), (25, 66), (25, 70), (25, 106), (25, 112), (25, 89), (25, 93), # 73-79
          (25, 88), (25, 100), (25, 103), (25, 94), (25, 97), (23, 114), (23, 116), # 80-86
          (45, 62), (45, 66), (45, 70), (45, 106), (45, 112), (45, 89), (45, 93), # 87-93
          (45, 88), (45, 100), (45, 103), (45, 94), (45, 97), (43, 114), (43, 116) # 94-100
    )
}
        ...
        for part in parts:
            ...
            try:
                ...
                for bid, v_node in enumerate(bone_pairs[benchmark]):
                    v1, v2 = v_node
                    if benchmark != 'kinetics' and bid < 73:
                        v1 -= 1
                        v2 -= 1
                    # if bid < 7:
                    ...
                    data_bone = data[:, :, :, v1, :] - data[:, :, :, v2, :]
                    if bid < 73:
                        fp_sp[:, :, :, bid, :] = data_bone.copy()
                    else:
                        data_bone[data_bone > 0.1] = 0.0
                        data_bone[data_bone < -0.1] = 0.0
                        data_bone = np.clip(data_bone, a_min=-0.1, a_max=0.1)
                        fp_sp[:, :, :, bid, :] = data_bone.copy()
